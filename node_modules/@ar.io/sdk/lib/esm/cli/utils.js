...
export function buyAntStateFromOptions(o) {
    ...
    if (o.targetProtocol !== undefined) {
        ...
        if (p === 'arweave' || p === '0')
            ...
            throw new Error('--target-protocol must be "arweave" or "ipfs"');
    }
    const state = {};
    const target = o.target ?? o.transactionId;
    if (target !== undefined)
        state.transactionId = target;
    if (o.ticker !== undefined)
        state.ticker = o.ticker;
    if (o.description !== undefined)
        state.description = o.description;
    if (o.keywords !== undefined)
        state.keywords = o.keywords;
    if (o.logo !== undefined)
        state.logo = o.logo;
    if (targetProtocol !== undefined)
        state.targetProtocol = targetProtocol;
