import { assertConfirmationPrompt, assertEnoughBalanceForArNSPurchase, buyAntStateFromOptions, customTagsFromOptions, fundFromFromOptions, fundingPlanFromOptions, positiveIntegerFromOptions, recordTypeFromOptions, referrerFromOptions, requiredPositiveIntegerFromOptions, requiredStringFromOptions, stringArrayFromOptions, withdrawalIdFromOptions, writeARIOFromOptions, } from '../utils.js';
...
export async function buyRecordCLICommand(o) {
    ...
    const antState = buyAntStateFromOptions(o);
