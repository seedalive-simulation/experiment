 ...
 */
export async function getAntAuthorityPDA(mint, programId = ARIO_ANT_PROGRAM_ID) {
    return getProgramDerivedAddress({
        programAddress: programId,
