...
export type SchemaVersionArgs = SchemaVersion;
export declare function getSchemaVersionEncoder(): FixedSizeEncoder<SchemaVersionArgs>;
export declare function getSchemaVersionDecoder(): FixedSizeDecoder<SchemaVersion>;
export declare function getSchemaVersionCodec(): FixedSizeCodec<SchemaVersionArgs, SchemaVersion>;
