...
export async function findNameRegistryPda(config = {}) {
    const { programAddress = 'ARioArnsProgXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' } = config;
...
//# sourceMappingURL=nameRegistry.js.map