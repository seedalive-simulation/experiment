 ...
 * ```
 */
export declare function fillProvisorySetComputeUnitLimitInstruction<TTransactionMessage extends TransactionMessage>(transactionMessage: TTransactionMessage): TTransactionMessage;
/**
 ...
 * ```
 */
export declare function updateOrAppendSetComputeUnitLimitInstruction<TTransactionMessage extends TransactionMessage>(units: number | ((previousUnits: number | null) => number), transactionMessage: TTransactionMessage): TTransactionMessage;
