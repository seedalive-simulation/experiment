import { TransactionMessage, Commitment, Rpc, SimulateTransactionApi, Slot, TransactionMessageWithFeePayer } from '@solana/kit';
...
export type EstimateComputeUnitLimitFactoryFunction = (transactionMessage: TransactionMessage & TransactionMessageWithFeePayer, config?: EstimateComputeUnitLimitFactoryFunctionConfig) => Promise<number>;
