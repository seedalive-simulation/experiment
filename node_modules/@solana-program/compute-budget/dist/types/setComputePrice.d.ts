 ...
 * ```
 */
export declare function setTransactionMessageComputeUnitPrice<TTransactionMessage extends TransactionMessage>(microLamports: number | bigint, transactionMessage: TTransactionMessage): TTransactionMessage extends TransactionMessage ? Omit<import("@solana/kit").ExcludeTransactionMessageWithinSizeLimit<TTransactionMessage>, "instructions"> & {
 ...
 * ```
 */
export declare function updateOrAppendSetComputeUnitPriceInstruction<TTransactionMessage extends TransactionMessage>(microLamports: MicroLamports | ((previousMicroLamports: MicroLamports | null) => MicroLamports), transactionMessage: TTransactionMessage): TTransactionMessage;
