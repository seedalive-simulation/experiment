...
async function findAddressLookupTablePda(seeds, config = {}) {
  ...
  return await kit.getProgramDerivedAddress({
    programAddress,
    seeds: [kit.getAddressEncoder().encode(seeds.authority), kit.getU64Encoder().encode(seeds.recentSlot)]
  });
}
...
function getAddressLookupTableEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ...
      ["authority", kit.getOptionEncoder(kit.getAddressEncoder(), { noneValue: "zeroes" })],
      ["padding", kit.getU16Encoder()],
      ["addresses", kit.getArrayEncoder(kit.getAddressEncoder(), { size: "remainder" })]
    ]),
...
function getAddressLookupTableDecoder() {
  return kit.getStructDecoder([
    ...
    ["authority", kit.getOptionDecoder(kit.getAddressDecoder(), { noneValue: "zeroes" })],
...
function getAddressLookupTableCodec() {
  return kit.combineCodec(getAddressLookupTableEncoder(), getAddressLookupTableDecoder());
}
function decodeAddressLookupTable(encodedAccount) {
  return kit.decodeAccount(encodedAccount, getAddressLookupTableDecoder());
}
...
function parseAddressLookupTableInstruction(instruction) {
  ...
  switch (instructionType) {
    case 0 /* CreateLookupTable */: {
      ...
      return {
        instructionType: 0 /* CreateLookupTable */,
    ...
    case 1 /* FreezeLookupTable */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 1 /* FreezeLookupTable */,
    ...
    case 2 /* ExtendLookupTable */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 2 /* ExtendLookupTable */,
    ...
    case 3 /* DeactivateLookupTable */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 3 /* DeactivateLookupTable */,
    ...
    case 4 /* CloseLookupTable */: {
      kit.assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: 4 /* CloseLookupTable */,
...
function getCloseLookupTableInstructionDataCodec() {
  return kit.combineCodec(getCloseLookupTableInstructionDataEncoder(), getCloseLookupTableInstructionDataDecoder());
}
...
function getCreateLookupTableInstructionDataCodec() {
  return kit.combineCodec(getCreateLookupTableInstructionDataEncoder(), getCreateLookupTableInstructionDataDecoder());
}
...
function getExtendLookupTableInstructionDataEncoder() {
  return kit.transformEncoder(
    kit.getStructEncoder([
      ["discriminator", kit.getU32Encoder()],
      ["addresses", kit.getArrayEncoder(kit.getAddressEncoder(), { size: kit.getU64Encoder() })]
    ]),
...
function getExtendLookupTableInstructionDataDecoder() {
  return kit.getStructDecoder([
    ["discriminator", kit.getU32Decoder()],
    ["addresses", kit.getArrayDecoder(kit.getAddressDecoder(), { size: kit.getU64Decoder() })]
  ]);
}
function getExtendLookupTableInstructionDataCodec() {
  return kit.combineCodec(getExtendLookupTableInstructionDataEncoder(), getExtendLookupTableInstructionDataDecoder());
}
function getExtendLookupTableInstruction(input, config) {
  ...
  const byteDelta = [resolveExtendLookupTableBytes(resolverScope)].reduce((a, b) => a + b, 0);
  const getAccountMeta = getAccountMetaFactory(programAddress);
  return Object.freeze({
    accounts: [
      getAccountMeta(accounts.address),
...
function getFreezeLookupTableInstructionDataCodec() {
  return kit.combineCodec(getFreezeLookupTableInstructionDataEncoder(), getFreezeLookupTableInstructionDataDecoder());
}
...
exports.parseAddressLookupTableInstruction = parseAddressLookupTableInstruction;
