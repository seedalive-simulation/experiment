...
every payment on time. Remaining assets: 16.42 USDC and 0.0592 SOL. The
...
authorized, so the agent emailed the founder and asked. Anthony replied yes —
...
Found and fixed with three weeks of runway left, by a reflex checking its
